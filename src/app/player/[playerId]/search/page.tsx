...
export default function SearchPage({ params: { playerId }}: {
    ...
    return <div className="p-4">
        <div className="">
            ...
            <SoundCloudTracks loaded={loaded} soundcloudTracks={soundcloudTracks} tracksLimit={tracksLimit} onPlay={(track: Track) => playTrack(track, true)} onQueueAdd={playTrack}/>
        </div>
    </div>;
}

function SoundCloudTracks({ soundcloudTracks, loaded, tracksLimit, onPlay, onQueueAdd }: Readonly<{

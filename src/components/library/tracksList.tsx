        ...
        >
          ...
          >
            <div className="flex bg-blue-light rounded-full w-10/12 aspect-square items-center justify-center">
              {(!isPlayingNow || isPaused) && (
                <FaPlay className="text-white-default text-lg ml-1" />
              )}
              <div
                className={`p-0.5 pl-1 hidden ${isPlayingNow && !isPaused && "!block"}`}
                ref={soundwaveBox}
              ></div>
            </div>
          </div>
...
function TrackSceleton() {
  return (
    <div className="flex w-full p-2 my-0.5">
      <div
        className="relative rounded overflow-hidden bg-blue-grayish animate-pulse"
...
export const DotSeparator = () => (
  <GoDotFill className="text-white-gray" style={{ fontSize: "8px" }} />
);
